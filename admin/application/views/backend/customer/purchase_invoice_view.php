        ...
        <div class="invoice-header">
            ...
            <div class="invoice-to">
                ...
                <address class="m-t-5 m-b-5">
                    ...
                    <?php echo translate('address');?>: <?php echo $this->db->get_where('customer' , array('customer_id' => $row['customer_id']))->row()->address;?><br />
                    <?php echo translate('phone');?>: <?php echo $this->db->get_where('customer' , array('customer_id' => $row['customer_id']))->row()->phone;?><br />
                    <?php echo translate('email');?>: <?php echo $this->db->get_where('customer' , array('customer_id' => $row['customer_id']))->row()->email;?>
                </address>
            </div>
            <div class="invoice-date">
                <div class="date m-t-5"><?php echo date('dS M, Y' , $row['timestamp']);?></div>
                <div class="invoice-detail">
                    <strong><?php echo translate('invoice_code');?>: <?php echo $row['invoice_code'];?></strong><br />
                    <?php 
                    ...
                    <strong><?php echo translate('payment_method');?>: <?php echo translate('cash');?></strong>
                    <?php endif;?>
                    <?php if ($payment_method == 2):?>
                    <strong><?php echo translate('payment_method');?>: <?php echo translate('check');?></strong>
                    <?php endif;?>
                    <?php if ($payment_method == 3):?>
                    <strong><?php echo translate('payment_method');?>: <?php echo translate('card');?></strong>
                    <?php endif;?>
                </div>
            </div>
        </div>
