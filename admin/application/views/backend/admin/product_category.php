...
<div id="content" class="content">
	...
	<!-- new product_category addition link -->
	<div class="row" style="margin-left: 1px;">
		<button onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/product_category_add');"
			...
			<i class="fa fa-plus"></i> <?php echo translate('add_new_category');?>
		</button>
	</div>
	    ...
	    <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title"><?php echo translate('all_product_categories');?></h4>
                </div>
                        ...
                        <table id="data-table" class="table table-striped table-bordered nowrap display" width="100%">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <button onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/product_category_edit/<?php echo $row['category_id']; ?>');" 
                                            class="btn btn-success btn-icon btn-circle btn-sm">
                                                <i class="fa fa-edit"></i>
                                        </button>
                                        <button onclick="showDeleteModal('<?php echo base_url();?>index.php?admin/product_category/delete/<?php echo $row['category_id']; ?>');" 
