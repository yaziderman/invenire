...
<div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li>
            <a href="<?php echo base_url();?>index.php?admin/pending_order">
                <?php echo translate('pending');?>
            </a>
        </li>
        <li>
            <a href="<?php echo base_url();?>index.php?admin/approved_order">
                <?php echo translate('approved');?>
            </a>
        </li>
        <li>
            <a href="<?php echo base_url();?>index.php?admin/rejected_order">
                <?php echo translate('rejected');?>
            </a>
        </li>
    </ol>
    <!-- end breadcrumb -->
		...
		<div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title"><?php echo translate('order_number') . ': ' . $row['order_number'];?></h4>
                </div>
                ...
                <div class="panel-body">
					...
					?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <input type="text" class="form-control" id="datepicker-autoClose" name="modifying_timestamp" data-parsley-required="true"
