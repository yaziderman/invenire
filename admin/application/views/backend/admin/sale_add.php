                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-6">
						...
						<div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9">
							    <select class="form-control selectpicker" data-size="10" data-live-search="true" data-style="btn-white" 
							    	data-parsley-required="true" name="seller_id"
							    		onchange="return get_employee(this.value)">
					                <option value="" selected><?php echo translate('select_seller');?></option>
					                <?php 
	                    ...
	                    <div class="table-responsive">
							<table class="table table-bordered">
								<tbody>
									...
									<tr>
										<td><?php echo translate('sold_by');?></td>
										<td id="sold_by_holder">
...
<script type="text/javascript">
    ...
    function calculate_grand_total() {
        ...
        {
            sub_total   +=   parseInt( $("#single_entry_total_"+ i).html() );
        ...
        if ($("#discount_percentage").val() == undefined){
        	discount_percentage = 0;
        }else{
        	discount_percentage    =   parseInt( $("#discount_percentage").val() );	
        }

        if ($("#vat_percentage").val() == undefined){
        	vat_percentage = 0;
        }else{
        	vat_percentage    =   parseInt( $("#vat_percentage").val() );	
        }
    ...
    jQuery(document).ready(function(){
    	$("body").on("change","select",function(x){
    		console.log(x);
    	});
	});

	function update_type_category(entry_number){
		$('#selling_type_id_'+ entry_number).selectpicker('deselectAll');
    	if ($('#selling_type_category_'+ entry_number).val() == 'service'){
    		$('#selling_type_id_'+ entry_number+' option[name="product"]').each(function(){$(this).hide();});
    		$('#selling_type_id_'+ entry_number+'  option[name="service"]').each(function(){$(this).show();});
    	}else if ($('#selling_type_category_'+ entry_number).val() == 'product'){
    		$('#selling_type_id_'+ entry_number+'  option[name="product"]').each(function(){$(this).show();});
    		$('#selling_type_id_'+ entry_number+'  option[name="service"]').each(function(){$(this).hide();});
    	}else{
    		$('#selling_type_id_'+ entry_number+'  option').each(function(){$(this).show();});
    	}
    	$('#selling_type_id_'+ entry_number).selectpicker('refresh');
    };
